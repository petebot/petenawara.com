...
<div class="pinkcontainer">
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			...
			<span class="comment_number"><a href="#comment-<?php comment_ID() ?>" title=""><span class="commentnum"><?php echo $commentcounter; ?></span></a></span>
			<span class="comment_author"><?php comment_author_link() ?></span><br />
			
			<p><?php comment_date('F jS, Y') ?> at <?php comment_time() ?> <?php edit_comment_link('Edit',' | ',''); ?></p><br />
